...
export type SuggestNotificationTimeInput = z.infer<
  typeof SuggestNotificationTimeInputSchema
>;
...
export type SuggestNotificationTimeOutput = z.infer<
  typeof SuggestNotificationTimeOutputSchema
>;

export async function suggestNotificationTime(
  input: SuggestNotificationTimeInput
): Promise<SuggestNotificationTimeOutput> {
